...
1. **构建镜像**
```bash
docker build -t oncology-global-data-to-lancet .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name oncology-global-data-to-lancet oncology-global-data-to-lancet
```
...
- **项目主页**: https://github.com/MoKangMedical/oncology-global-data-to-lancet
- **问题反馈**: https://github.com/MoKangMedical/oncology-global-data-to-lancet/issues
